...
export default function RegisterPage() {
  ...
  return (
    <div className="register-page min-h-screen grid grid-cols-12 items-center md:px-12 px-4 gap-4 bg-pattern">
      <Formik
        initialValues={{
          firstName: '',
          lastName: '',
      ...
      <div className="register-img col-span-7 hidden md:block">
        <img src={registerImg} alt="registration" className="max-h-[630px]" />
      </div>
    </div>
  );
}
